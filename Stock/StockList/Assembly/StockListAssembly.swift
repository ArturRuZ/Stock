...
final class StockListAssembly {
  func build(dataProvider: DataProviderStockPlaceListReaderProtocol, delegate: StockListPresenterDelegateProtocol) -> (controller: UIViewController, presenter: StockListPresenterInputProtocol)? {
